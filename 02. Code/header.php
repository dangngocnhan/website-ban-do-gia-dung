...
<head>
    ...
    <title>Website - GiaDung</title> 
    <link rel="shortcut icon" href="./image/icon-giadung.jpg">
    <script src="https://kit.fontawesome.com/54f0cb7e4a.js" crossorigin="anonymous"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    <link rel="stylesheet" href="css/mainstyle6.css"> 
            ...
            <div class="row">
                    ...
                    <ul>
                        ...
                        <li><?php echo $result['danhmuc_ten'] ?>
                            <ul class="top-menu-item">
                                    ...
                                    ?>
                                    <a href="cartegory.php?loaisanpham_id=<?php echo $result['loaisanpham_id'] ?>"><li><?php echo $result['loaisanpham_ten'] ?></li></a>
                                    <?php
                                     } }
                                    ?>
                            </ul>
                ...
                <div class="top-menu-icons">
                    <ul>
                        ...
                        <li>
                            <a style="color: black;" href="./detaill.php"><i class="fas fa-user-secret"></i></a>
                        </li>
                        <!-- 
                            ...
                            <?php
                             ...
                             ?>   
                                ...
                                <div class="cart-content-mini-item">
                                    <img style="width:90px;cart-content-mini-item;margin-top: -10px;" src="<?php echo $result['sanpham_anh']  ?>" alt="">
                                    <div class="cart-content-item-text">
                                        <h1><?php echo $result['sanpham_tieude']  ?></h1>  
                                        <!-- <h1><php echo $result['sanpham_ma']  ?></h1>   -->
                                        <p>Giá: <?php echo number_format($result['sanpham_gia']) ?> đ</p>  
                                        <p>SL: <?php echo $result['quantitys']  ?></p>
                                    </div> 
                                </div>
                                <hr style="width: 80%; margin: -25px 0 0 25px ;">
                                    <?php
