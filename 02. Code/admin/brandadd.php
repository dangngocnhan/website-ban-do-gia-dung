...
?>
        <div class="admin-content-right">
            <div class="subcartegory-add-content">
                ...
                <label for="">Chọn danh mục sản phẩm<span style="color: red;">*</span></label> <br>
                    ...
                    <input required class="subcartegory-input" type="text" name="loaisanpham_ten">
                    <button class="admin-btn" type="submit">Thêm loại sản phẩm</button>             
                </form>
            </div>           
        </div>
    </section>
