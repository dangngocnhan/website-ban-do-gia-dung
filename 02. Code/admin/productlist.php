...
?>
        <div class="admin-content-right">
            <div class="table-content">
                <table>
                  ...
                  ?>
                    <tr>
                        ...
                        <td> <img style="width: 100px; height: 50px" src="uploads/<?php echo $result['sanpham_anh_chitiet'] ?>" alt=""></td>                              
               ...
               <button class="button_themdanhmuc"><a href="./productadd.php">Thêm mới sản phẩm</a></button>    
        </div>
    </section>
    <section>
    </section>
